...
import org.project.eye_game.AppRTCClient.SignalingParameters;
import org.project.eye_game.PeerConnectionClient.DataChannelParameters;
import org.project.eye_game.PeerConnectionClient.PeerConnectionParameters;
...
public class CallActivity extends Activity implements org.project.eye_game.AppRTCClient.SignalingEvents,
  ...
  @Nullable
  private org.project.eye_game.PeerConnectionClient peerConnectionClient;
  @Nullable
  private org.project.eye_game.AppRTCClient appRtcClient;
  @Nullable
  private SignalingParameters signalingParameters;
  @Nullable private org.project.eye_game.AppRTCAudioManager audioManager;
  @Nullable
  ...
  // Controls
  private org.project.eye_game.CallFragment callFragment;
  private org.project.eye_game.HudFragment hudFragment;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    callFragment = new org.project.eye_game.CallFragment();
    hudFragment = new org.project.eye_game.HudFragment();
    ...
    if (loopback || !org.project.eye_game.DirectRTCClient.IP_PATTERN.matcher(roomId).matches()) {
      appRtcClient = new org.project.eye_game.WebSocketRTCClient(this);
    } else {
      Log.i(TAG, "Using DirectRTCClient because room name looks like an IP.");
      appRtcClient = new org.project.eye_game.DirectRTCClient(this);
    }
    ...
    peerConnectionClient = new org.project.eye_game.PeerConnectionClient(
  ...
  private void startCall() {
    ...
    audioManager = org.project.eye_game.AppRTCAudioManager.create(getApplicationContext());
