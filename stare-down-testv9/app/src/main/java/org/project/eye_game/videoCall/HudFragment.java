...
public class HudFragment extends Fragment {
  ...
  private org.project.eye_game.CpuMonitor cpuMonitor;
  ...
  public void onStart() {
    ...
    if (args != null) {
      ...
      displayHud = args.getBoolean(org.project.eye_game.CallActivity.EXTRA_DISPLAY_HUD, false);
    }
  ...
  public void setCpuMonitor(org.project.eye_game.CpuMonitor cpuMonitor) {
  ...
  public void updateEncoderStatistics(final StatsReport[] reports) {
    ...
    for (StatsReport report : reports) {
      if (report.type.equals("ssrc") && report.id.contains("ssrc") && report.id.contains("send")) {
        ...
        if (trackId != null && trackId.contains(org.project.eye_game.PeerConnectionClient.VIDEO_TRACK_ID)) {
