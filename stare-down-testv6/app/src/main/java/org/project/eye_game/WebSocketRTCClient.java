...
import org.project.eye_game.RoomParametersFetcher.RoomParametersFetcherEvents;
import org.project.eye_game.WebSocketChannelClient.WebSocketChannelEvents;
import org.project.eye_game.WebSocketChannelClient.WebSocketConnectionState;
import org.project.eye_game.util.AsyncHttpURLConnection;
import org.project.eye_game.util.AsyncHttpURLConnection.AsyncHttpEvents;
 ...
 */
public class WebSocketRTCClient implements org.project.eye_game.AppRTCClient, WebSocketChannelEvents {
  ...
  private org.project.eye_game.WebSocketChannelClient wsClient;
  ...
  private void connectToRoomInternal() {
    ...
    roomState = ConnectionState.NEW;
    wsClient = new org.project.eye_game.WebSocketChannelClient(handler, this);
    ...
    new org.project.eye_game.RoomParametersFetcher(connectionUrl, null, callbacks).makeRequest();
  }
