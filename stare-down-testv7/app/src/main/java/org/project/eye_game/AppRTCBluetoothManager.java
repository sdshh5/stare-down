...
public class AppRTCBluetoothManager {
  ...
  private final org.project.eye_game.AppRTCAudioManager apprtcAudioManager;
  @Nullable
  ...
  /** Construction. */
  static AppRTCBluetoothManager create(Context context, org.project.eye_game.AppRTCAudioManager audioManager) {
    Log.d(TAG, "create" + AppRTCUtils.getThreadInfo());
    return new AppRTCBluetoothManager(context, audioManager);
  }

  protected AppRTCBluetoothManager(Context context, org.project.eye_game.AppRTCAudioManager audioManager) {
    Log.d(TAG, "ctor");
